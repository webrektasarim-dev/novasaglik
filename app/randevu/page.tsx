...
export const metadata: Metadata = {
  title: "Randevu Al - Nova Sağlık Hizmetleri",
  description: "Online randevu alın. Evde sağlık hizmetleri için hemen randevu oluşturun. 7/24 hizmetinizdeyiz.",
  openGraph: {
    title: "Randevu Al - Nova Sağlık Hizmetleri",
    description: "Online randevu sistemi ile hızlı ve kolay randevu alın",
    url: 'https://novasaglik.com/randevu',
  },
};
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200">
              Hızlı ve kolay randevu sistemi ile size en uygun zamanı seçin. 
              Uzman hemşirelerimiz en kısa sürede sizinle iletişime geçecektir.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Form Doldurun</h3>
                <p className="text-gray-600">Yukarıdaki formu eksiksiz doldurun</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#14b8a6] to-[#10b981] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  2
                </div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">Onay Bekleyin</h3>
                <p className="text-gray-600">Ekibimiz talebinizi değerlendirir</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#14b8a6] to-[#10b981] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  3
                </div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">Hizmet Alın</h3>
                <p className="text-gray-600">Uzman hemşiremiz randevunuzda</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="medical-card max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Acil Durum mu?</h3>
              <p className="text-gray-600">7/24 destek hattımızdan hemen ulaşın</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xl font-bold">Hemen Mesaj</div>
                </div>
              </a>
            </div>
          </div>
