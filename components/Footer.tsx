        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              7/24 evde ve klinik sağlık hizmetleri. Uzman hemşirelerimizle yanınızdayız.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className="text-gray-400 hover:text-[#14b8a6] transition-colors text-sm">
                  Ana Sayfa
                </a>
              </li>
              <li>
                <a href="/hizmetler" className="text-gray-400 hover:text-[#14b8a6] transition-colors text-sm">
                  Hizmetlerimiz
                </a>
              </li>
              <li>
                <a href="/hakkimizda" className="text-gray-400 hover:text-[#14b8a6] transition-colors text-sm">
                  Hakkımızda
                </a>
              </li>
              <li>
                <a href="/blog" className="text-gray-400 hover:text-[#14b8a6] transition-colors text-sm">
                  Blog
                </a>
              </li>
              <li>
                <a href="/iletisim" className="text-gray-400 hover:text-[#14b8a6] transition-colors text-sm">
                  İletişim
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="mailto:info@novasaglik.com" className="text-gray-400 hover:text-[#14b8a6] text-sm transition-colors">
                    info@novasaglik.com
                  </a>
                </div>
              </li>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © 2024 Nova Sağlık Hizmetleri. Tüm hakları saklıdır.
