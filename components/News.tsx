    ...
    <section id="blog">
      ...
      {loading ? (
        ...
        <div className="bg-gray-50 rounded-lg p-6 text-center">
          ...
          <p className="text-gray-600 text-sm">Henüz blog yazısı yok</p>
        </div>
      ) : (
        <div className="space-y-4">
          {newsItems.map((news) => (
            ...
            >
              <div className="flex flex-col sm:flex-row h-full min-h-[140px] sm:min-h-[120px]">
                {/* Image */}
                <div className="relative w-full sm:w-32 md:w-36 h-32 sm:h-full flex-shrink-0 bg-gray-200 overflow-hidden">
                  {news.image ? (
                    <Image
                      src={news.image}
                      alt={news.title}
                ...
                <div className="flex-1 p-3 sm:p-4 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-base sm:text-lg font-bold mb-1.5 text-gray-800 line-clamp-2 group-hover:text-[#14b8a6] transition-colors">
                      {news.title}
                    </h3>
                    <p className="text-gray-600 mb-2 text-xs leading-relaxed line-clamp-2 sm:line-clamp-2">
                      {news.excerpt}
                    </p>
                  </div>
